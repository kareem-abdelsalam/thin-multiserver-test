...
def create_package(target)
  ...
  sh "cp packaging/successeding_app.sh #{package_dir}/successeding_app"
  sh "chmod +x #{package_dir}/successeding_app"
  sh "cp packaging/failing_app.sh #{package_dir}/failing_app"
  sh "chmod +x #{package_dir}/failing_app"  
